...
var MainScene = /** @class */ (function (_super) {
    ...
    function MainScene(param) {
        ...
        _this.loaded.add(function () {
            ...
            uiBase.hide();
            //タイトル
            var sprTitle = new g.Sprite({ scene: _this, src: _this.assets["title"] });
            ...
            var numFontBlue = new g.BitmapFont({
                src: _this.assets["img_numbers_n_blue"],
                map: glyph.map,
                defaultGlyphWidth: glyph.width,
                defaultGlyphHeight: glyph.height,
                missingGlyph: glyph.missingGlyph
            });
            _this.numFontBlue = numFontBlue;
            ...
            //タイム
            uiBase.append(new g.Sprite({ scene: _this, src: _this.assets["time"], x: 0, y: 5 }));
            var labelTime = new g.Label({ scene: _this, font: numFont, fontSize: 32, text: "70", x: 40, y: 8 });
            ...
            var reset = function () {
                ...
                startTime = Date.now();
                game.destroy();
                game = new MainGame_1.MainGame(_this);
                base.append(game);
                game.reset();
